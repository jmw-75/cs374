...
/**
 * Vector square root: C = sqrt(A).
 *
 * This sample is a very basic sample that implements element by element
 * vector root. It is the same as the sample illustrating Chapter 2
 * of the programming guide with some roots like error checking.
 */
 ...
 *
 * Computes the vector root of A = C. 
...
int main(int argc, char** argv)
{
    ...
    printf("[Vector Root of %lu elements]\n", numElements);
    ...
    // 3. Launch the Vector Root CUDA Kernel
    ...
    checkErr(err, "Failed to launch vectorRoot kernel");
