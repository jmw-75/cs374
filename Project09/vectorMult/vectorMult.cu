 ...
 * vector multiplications. It is the same as the sample illustrating Chapter 2
 * of the programming guide with some multiplications like error checking.
 */
 ...
 *
 * Computes the vector mult of A and B into C. 
...
int main(int argc, char** argv)
{
    ...
    // 3. Launch the Vector Mult Kernel
