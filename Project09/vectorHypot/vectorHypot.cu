 ...
 * 
 * Extended^2 for use in CS 374 by John White on thursday, December 2, 2021
 * to find the hypotnuse of all the elements in arrays, A, B, and C using a 
 * sequential and CUDA computation whle measuring efficiency of both.
 */

/**
 * Vector hypot: C = sqrt(A^2 + B^2).
 *
 * This sample is a very basic sample that implements finding the hypotnuse of a triangle 
 * using vectors. It is the same as the sample illustrating Chapter 2
 * of the programming guide with some multiplications and SQRTS like error checking.
 */
 ...
 *
 * Computes the vector hypot of squareRoot(A^2 + B^2) = C. 
...
int main(int argc, char** argv)
{
    ...
    printf("[Vector hypot of %lu elements]\n", numElements);
    ...
    // 3. Launch the Vector Hypot Kernel
    ...
    checkErr(err, "Failed to launch vector kernel");
